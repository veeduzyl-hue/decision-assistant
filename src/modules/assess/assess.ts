...
import { computeRiskScore } from "../risk/risk_score.js";
import { decide } from "../risk/decision.js";
import type { Signals, Answers } from "../risk/types.js";

// v0.2 infra + guardrail
import { evaluate } from "../policy/evaluate.js";
import type { PolicyDecision } from "../policy/types.js";
import { evaluateGuardrail } from "../receipt/evaluate_guardrail.js";
import type { GuardrailDecision, GuardrailReceipt } from "../receipt/types.js";
import type { DecisionSignal } from "./signal.js";
...
function makeNonce(): string {
  return `nonce_${randomUUID().replace(/-/g, "").slice(0, 16)}`;
}
        ...
        return {
          ...
          guardrail: {
            ...
            confirmation: {
              ...
              provided: { receipt_id: confirm.receipt_id, plan_hash: confirm.plan_hash, nonce: confirm.nonce },
              expected: { plan_hash },
            },
          },
        };
